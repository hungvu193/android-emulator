...
public class ScreenViewPortSettingsActivity extends ImmersiveActivity implements
		OnGameMenuListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (font != null) {
			MultitouchButton start = (MultitouchButton) mtLayer
					.findViewById(R.id.button_start);
			MultitouchButton select = (MultitouchButton) mtLayer
